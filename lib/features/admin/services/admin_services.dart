...
class AdminServices {
  void sellProduct({
    ...
    try {
      final cloudinary = CloudinaryPublic('dpooo1is3', 'chue8y7o');
    ...
    try {
      ...
      httpErrorHandle(
        ...
        onSuccess: () {
          ...
          sales = [
            Sales('Chairs', response['chairEarnings']),
            Sales('Tables', response['tableEarnings']),
            Sales('Beds', response['bedEarnings']),
            Sales('Sofas', response['sofaEarnings']),
